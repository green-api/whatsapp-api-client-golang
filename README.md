...
| How to edit message                                  | [editMessage/main.go](examples/editMessage/main.go)                                 |
| How to send forward messages                         | [sendForwardMessages/main.go](examples/sendForwardMessages/main.go)                         |
...
| `Status().SendMediaStatus`              | The method is used to sending a pictures or video status                                                     | [SendMediaStatus](https://green-api.com/en/docs/api/statuses/SendMediaStatus/)                                          |      
...
| `Service().EditMessage`                 | The  method is editing the text message into a personal or a group chat                                         | [EditMessage](https://green-api.com/en/docs/api/service/EditMessage/)                       |
